...
if __name__ == "__main__":
    ...
    url_confirmed = 'https://api.covid19api.com/total/dayone/country/korea-south/status/confirmed'
    url_recovered = 'https://api.covid19api.com/total/dayone/country/korea-south/status/recovered'
    url_deaths = 'https://api.covid19api.com/total/dayone/country/korea-south/status/deaths'
