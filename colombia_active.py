...
if __name__ == "__main__":
    ...
    url_confirmed = 'https://api.covid19api.com/total/dayone/country/colombia/status/confirmed'
    url_recovered = 'https://api.covid19api.com/total/dayone/country/colombia/status/recovered'
    url_deaths = 'https://api.covid19api.com/total/dayone/country/colombia/status/deaths'
